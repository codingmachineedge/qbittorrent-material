...
qint64 Utils::Misc::sizeInBytes(qreal size, const Utils::Misc::SizeUnit unit)
{
...
QString Utils::Misc::languageToLocalizedString(const QStringView localeStr)
{
    ...
    const QLocale locale {localeStr.toString()};
    ...
    default:
        ...
        qCWarning(lcI18n) << "Utils::Misc: unrecognized language name:" << lang;
        return lang;
    }
}
